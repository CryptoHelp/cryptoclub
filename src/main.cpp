...
const string strMessageMagic = "CryptoClub Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CryptoClub", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "14/07";
        CTransaction txNew;
        txNew.nTime = 1405330200;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1405330220;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1391422;
		if(fTestNet)
        {
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x7d70d8c2084757d87a0777395df498a0931750e033e64711eefd9c443a9e03f9"));
        block.print();
